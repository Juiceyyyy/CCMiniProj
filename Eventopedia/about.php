            ...
            <div class="row pt-lg-4">
                <div class="col-lg-5">
                    <div class="wthree_pvt_title  mb-3">
                        <h4 class="w3pvt-title">about Hysteria
                        </h4>
                    ...
                    <div class="single_grid_text pt-lg-3">
                        ...
                        <p>
                        So we decided to develop a website where everyone can easily register in events quickly and easily. The event organizer will use ‘Hysteria’ to organize the event. The participation can register in the event by providing a valid <b>College ID card</b>.
                        </p>
                        <p>
                        The advantage of using ‘Hysteria’ is that:
                        <ul>

                        <li> • Quick and easy participation.</li>
                        <!---<li> • Certificate will be easily delivered to the participants.</li>------->
                        <li> • Approval of participants on the basis of their college ID.</li>
                        </ul>
                        </p>
                        <p>
